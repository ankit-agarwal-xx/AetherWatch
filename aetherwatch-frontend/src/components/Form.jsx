...
export default function Form({
    ...
    return (
        <div className='w-11/12 max-w-[700px] px-10 py-20 rounded-3xl bg-gradient-to-r from-orange-500 to-orange-800 bg-opacity-75 border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                ...
                <div className='mt-8 flex justify-center items-center'>
                    <p className='font-medium text-base'>Donot have an account?</p>
                    <button 
